...
const (
	CHAR_STATE_IDLE           components.CharState = "idle"
	CHAR_STATE_WALK           components.CharState = "walk"
	CHAR_STATE_RUN            components.CharState = "run"
	CHAR_STATE_JUMP           components.CharState = "jump"
