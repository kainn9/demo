...
const (
	...
	PLAYER_ANIM_STATE_ATTACK_PRIMARY_SPEED = 6
	...
	PLAYER_ANIM_STATE_ATTACK_PRIMARY_FRAME_COUNT = 9
	...
	// Attacks.
	PLAYER_ANIM_STATE_ATTACK_PRIMARY components.AnimState = "atkPrimary"
)

var PLAYER_ANIMATION_CONFIGS = map[components.AnimState]*components.AnimationConfig{
	// Movement.
	PLAYER_ANIM_STATE_IDLE: components.NewAnimationConfig(
	...
	PLAYER_ANIM_STATE_RUN: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
	...
	PLAYER_ANIM_STATE_JUMP: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
	...
	PLAYER_ANIM_STATE_FALL: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
	...
	PLAYER_ANIM_STATE_CLIMB_LADDER_IDLE: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
	...
	PLAYER_ANIM_STATE_CLIMB_LADDER_ACTIVE: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
	...
	PLAYER_ANIM_STATE_ATTACK_PRIMARY: components.NewAnimationConfig(
		PLAYER_ANIMATIONS_SPRITE_WIDTH,
		PLAYER_ANIMATIONS_SPRITE_HEIGHT,
		PLAYER_ANIM_STATE_ATTACK_PRIMARY_FRAME_COUNT,
		PLAYER_ANIM_STATE_ATTACK_PRIMARY_SPEED,
		false,
	),
}
...
var PlayerAttackDataMap = map[components.AnimState]*PlayerAttackData{
	PLAYER_ANIM_STATE_ATTACK_PRIMARY: {
		TotalTickLength: PLAYER_ANIM_STATE_ATTACK_PRIMARY_FRAME_COUNT * PLAYER_ANIM_STATE_ATTACK_PRIMARY_SPEED,
		TicksPerFrame:   PLAYER_ANIM_STATE_ATTACK_PRIMARY_SPEED,
	},
}
