...
// TODO:
// Look into breaking this up into sep packages or maybe some kind
// of YAML/JSON config file + loader.
...
const (
	...
	PLAYER_ANIM_STATE_CLIMB_LADDER_IDLE   = "climbLadderIdle"
	PLAYER_ANIM_STATE_CLIMB_LADDER_ACTIVE = "climbLadderActive"
)
